sap.ui.define([
	...
	var superarr = [];
	var oMessagePopover;
	return Controller.extend("AR_DP_REP_PEDIDO_RASA.AR_DP_REP_PEDIDO_RASA.controller.VerificadoUrgente", {

		onInit: function () {
			var oRouter =
				sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("VerificadoUrgente").attachMatched(this._onRouteMatched, this);
				...
				$.ajax({
					...
					success: function (dataR, textStatus, jqXHR) {
						...
						if (dataR.d !== "" || dataR.d !== undefined || dataR.d !== null) {
							...
							console.log("dataR linea 765:", dataR);
							try {
  ...
  var appModulePath = jQuery.sap.getModulePath(appid);
				...
				$.ajax({
					...
					success: function (dataR, textStatus, jqXHR) {
						...
						if (dataR.HeaderSet !== "" || dataR.HeaderSet !== undefined || dataR.HeaderSet !== null) {
							...
							console.log("dataR linea 910:", dataR);
							try {
		...
		atras: function () {
			...
			console.log(arreglo);
			sap.ui.controller("AR_DP_REP_PEDIDO_RASA.AR_DP_REP_PEDIDO_RASA.controller.CrearPedidoUrgente").jsoncreacion(cliente, pedido, destino,
				arreglo, oUsuariosap);
			//FIN
			var oRouter = this.getOwnerComponent().getRouter();
