sap.ui.define([
	...
	var superarr = [];
	var oMessagePopover;
	return Controller.extend("AR_DP_REP_PEDIDO_RASA.AR_DP_REP_PEDIDO_RASA.controller.VerificaInmovilizado", {

		onInit: function () {
			var oRouter =
				sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("verificadoInmovilizado").attachMatched(this._onRouteMatched, this);
		...
		handleValueHelp: function (oEvent) {
			...
			if (!this._valueHelpDialog) {
				this._valueHelpDialog = sap.ui.xmlfragment("AR_DP_REP_PEDIDO_RASA.AR_DP_REP_PEDIDO_RASA.view.PopUpdescartadosInmovilizado",
					this
				);
  ...
  var appModulePath = jQuery.sap.getModulePath(appid);
		...
		DemandaPerdidaCab: function () {
			...
			that._oDataHanaModel.create("/PedidoDemanda", json, null, function (odata, oResponse) {
		...
		atras: function () {
			...
			sap.ui.controller("AR_DP_REP_PEDIDO_RASA.AR_DP_REP_PEDIDO_RASA.controller.CrearPedidoInmovilizado").jsoncreacion(cliente, pedido, destino,
