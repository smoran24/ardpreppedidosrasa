sap.ui.define([
	...
	let that;
	return Controller.extend("AR_DP_REP_PEDIDO_RASA.AR_DP_REP_PEDIDO_RASA.controller.CrearPedidoAnormal", {
		...
		onInit: function () {
			...
			oRouter.getRoute("CrearPedidoAnormal").attachMatched(this._onRouteMatched, this);
		},
  ...
  var appModulePath = jQuery.sap.getModulePath(appid);
		...
		navToVerificadoAnormal: function(){
			var oRouter = this.getOwnerComponent().getRouter();
			oRouter.navTo("VerificadoAnormal");
		},
